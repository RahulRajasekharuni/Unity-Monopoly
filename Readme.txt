...
Game will only last until either of the players goes around the board three times. Whenever the player passes the Go location he/she will receive 200 cash. If the player lands on one of the tax location he/she will lose the amount of cash that location specifies. The output button will write to file the dice rolls, names of properties owned and remaining cash of each player. The file is named output.txt and will be in the same folder as the executable.
